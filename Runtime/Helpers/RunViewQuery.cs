...
//         /// <returns></returns>
//         public Task<T> PostAsync<T>(string contract, string view, object input, UnparsingMode unparsing_mode = UnparsingMode.Readable, string source = null, string payer = null, long? gas = null)
//             => PostAsync<T>(new
//             {
//                 contract,
//                 view,
