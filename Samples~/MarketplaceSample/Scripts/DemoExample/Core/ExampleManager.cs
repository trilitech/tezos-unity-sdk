...
namespace TezosSDK.Samples.DemoExample
{
    public class ExampleManager : IExampleManager
    {
        ...
        {
            Logger.LogDebug(
                $"Transfering item {itemID} from {Tezos.Wallet.GetWalletAddress()} to Address: {address}");
        ...
        public IWalletEventManager GetWalletMessageReceiver() => Tezos.Wallet.EventManager;
