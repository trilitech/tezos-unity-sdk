...
namespace Netezos.Rpc
{
    ...
    public class RpcMethod : RpcQuery
    {
        ...
        /// <returns></returns>
        public IEnumerator PostAsync(string content) => Client.PostJson(Query, content);
        ...
        /// <returns></returns>
        public IEnumerator PostAsync(object content) => Client.PostJson(Query, content);
        ...
        /// <param name="content">Json content to send</param>
        /// <returns></returns>
        public IEnumerator PostAsync<T>(string content) => Client.PostJson<T>(Query, content);
        ...
        /// <param name="content">Object to send</param>
        /// <returns></returns>
        public IEnumerator PostAsync<T>(object content) => Client.PostJson<T>(Query, content);
    }
}
