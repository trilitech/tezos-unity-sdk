...
namespace Netezos.Rpc.Queries
{
    ...
    public class BlocksQuery : RpcObject
    {
        ...
        /// <returns></returns>
        public IEnumerator GetAsync(int length)
        ...
        /// <param name="length">Number of blocks per head (head + predessors) to returns</param>
        /// <returns></returns>
        public IEnumerator GetAsync(DateTime minDate, int length = 1)
        ...
        /// <returns></returns>
        public IEnumerator GetAsync(string head, int length = 1)
        ...
        /// <param name="length">Number of blocks per head (head + predessors) to returns</param>
        /// <returns></returns>
        public IEnumerator GetAsync(List<string> heads, int length = 1)
        ...
        /// <param name="length">Number of blocks per head (head + predessors) to returns</param>
        /// <returns></returns>
        public IEnumerator GetAsync<T>(int length)
        ...
        /// <param name="length">Number of blocks per head (head + predessors) to returns</param>
        /// <returns></returns>
        public IEnumerator GetAsync<T>(DateTime minDate, int length = 1)
        ...
        /// <param name="length">Number of blocks (head + predessors) to returns</param>
        /// <returns></returns>
        public IEnumerator GetAsync<T>(string head, int length = 1)
        ...
        /// <param name="length">Number of blocks per head (head + predessors) to returns</param>
        /// <returns></returns>
        public IEnumerator GetAsync<T>(List<string> heads, int length = 1)
