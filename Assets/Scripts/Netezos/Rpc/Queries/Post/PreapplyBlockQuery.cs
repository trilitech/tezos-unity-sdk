...
namespace Netezos.Rpc.Queries.Post
{
    ...
    public class PreapplyBlockQuery : RpcMethod
    {
        ...
        /// <returns></returns>
        public IEnumerator PostAsync(string protocol, int priority, string powNonce, string signature, List<List<object>> operations, string seedNonceHash = null)
            => PostAsync(new
            {
                protocol_data = new
                {
        ...
        /// <param name="seedNonceHash">Seed nonce hash (optional)</param>
        /// <returns></returns>
        public IEnumerator PostAsync(string protocol, int priority, string powNonce, string signature,
        ...
        /// <param name="seedNonceHash">Seed nonce hash (optional)</param>
        /// <returns></returns>
        public IEnumerator PostAsync<T>(string protocol, int priority, string powNonce, string signature, List<List<object>> operations, string seedNonceHash = null)
            => PostAsync<T>(new
            {
                protocol_data = new
                {
        ...
        /// <param name="seedNonceHash">Seed nonce hash (optional)</param>
        /// <returns></returns>
        public IEnumerator PostAsync<T>(string protocol, int priority, string powNonce, string signature,
            List<List<object>> operations, DateTime timestamp, bool sort = false, string seedNonceHash = null)
                => Client.PostJson<T>(
                    $"{Query}?sort={sort}&timestamp={timestamp.ToUnixTime()}",
                    new
