...
namespace Netezos.Rpc.Queries.Post
{
    ...
    public class ForgeBlockHeaderQuery : RpcMethod
    {
        ...
        /// <returns></returns>
        public IEnumerator PostAsync(int level, int proto, string predecessor, DateTime timestamp,
        ...
        /// <returns></returns>
        public IEnumerator PostAsync<T>(int level, int proto, string predecessor, DateTime timestamp,
            int validationPass, string operationsHash, List<string> fitness, string context, string protocolData)
                => PostAsync<T>(new
                {
                    level,
