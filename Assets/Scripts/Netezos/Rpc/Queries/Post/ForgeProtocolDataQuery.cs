...
namespace Netezos.Rpc.Queries.Post
{
    ...
    public class ForgeProtocolDataQuery : RpcMethod
    {
        ...
        /// <returns></returns>
        public IEnumerator PostAsync(int priority, string nonceHash, string powNonce)
            => PostAsync(new
            {
                priority,
        ...
        /// <returns></returns>
        public IEnumerator PostAsync<T>(int priority, string nonceHash, string powNonce)
            => PostAsync<T>(new
            {
                priority,
                nonce_hash = nonceHash,
