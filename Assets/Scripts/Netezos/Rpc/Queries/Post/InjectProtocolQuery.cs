...
namespace Netezos.Rpc.Queries.Post
{
    ...
    public class InjectProtocolQuery : RpcMethod
    {
        ...
        /// <returns></returns>
        public IEnumerator PostAsync(int expectedEnvVersion, List<object> components,bool async = false, bool force = false)
            => Client.PostJson(
        ...
        /// <returns></returns>
        public IEnumerator PostAsync<T>(int expectedEnvVersion, List<object> components, bool async = false, bool force = false)
            => Client.PostJson<T>(
                $"{Query}?async={async}&force={force}",
                new
                {
