...
namespace Netezos.Rpc.Queries.Post
{
    ...
    public class RunOperationQuery : RpcMethod
    {
        ...
        /// <returns></returns>
        public IEnumerator PostAsync(string chain_id, string branch, params OperationContent[] contents)
            => PostAsync(new
            {
                operation = new
                {
        ...
        /// <param name="contents">List of operation contents</param>
        /// <returns></returns>
        public IEnumerator PostAsync<T>(string chain_id, string branch, params OperationContent[] contents)
            => PostAsync<T>(new
            {
                operation = new
                {
