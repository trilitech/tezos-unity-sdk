...
namespace Netezos.Rpc.Queries.Post
{
    ...
    public class RunCodeQuery : RpcMethod
    {
        ...
        /// <returns></returns>
        public IEnumerator PostAsync(object script, object storage, object input, long amount, string source = null, string payer = null, long? gas = null)
            => PostAsync(new
            {
                script,
                storage,
        ...
        /// <param name="gas">Gas limit (optional)</param>
        /// <returns></returns>
        public IEnumerator PostAsync<T>(object script, object storage, object input, long amount, string source = null, string payer = null, long? gas = null)
            => PostAsync<T>(new
            {
                script,
                storage,
